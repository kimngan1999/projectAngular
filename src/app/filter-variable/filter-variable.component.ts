...
export class FilterVariableComponent implements OnInit {
  ...
  public url:string = "http://172.29.65.199:3000/d-solo/jw8yQzW7z/dashboard-data_links?orgId=1&var-data_out=60000&from=1623997080000&to=1623997739000&panelId=2"
  ...
  onChange(data:any) {
    ...
    var str = "http://172.29.65.199:3000/d-solo/jw8yQzW7z/dashboard-data_links?orgId=1&var-data_out="+data.target.value+"&from=1623997080000&to=1623997739000&panelId=2"
