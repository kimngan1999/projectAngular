...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  init_url:SafeResourceUrl = "http://172.29.65.193:8088/dashboard/script/scripted.js?orgId=1&refresh=5s&from=1609434000000&to=1625734491307";
  ...
  ngOnInit(): void {
    ...
    this.init_url = this.sanitizer.bypassSecurityTrustResourceUrl( "http://172.29.65.193:8080/login/");
  ...
  ngAfterViewInit(): void{
    ...
    (function ($) {
      ...
      $(document).ready(function(){
        ...
        let locationValue = new URL("http://172.29.65.193/dashboard/script/scripted.js?orgId=1&refresh=5s&from=now%2Fd&to=now%2Fd&kiosk=tv");
        ...
        if(winURL.search == ""){
          ...
          let new_url = "http://172.29.65.193/dashboard/script/scripted.js" + winURL.search;
        ...
        window.addEventListener("message", function (event) {
          ...
          if (window.location.href == "http://172.29.65.193/dashboard/script/scripted.js?orgId=1&refresh=5s&from=now%2Fd&to=now%2Fd&kiosk=tv") {
